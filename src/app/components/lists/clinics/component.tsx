export const Clinics = () => {
  return (
    <ul className="clinics__list">
      ...
      <li className="clinics__list-item">
        <h3>Barretos</h3>
        <p>Calçadão da 21, 589 - Centro</p>
      </li>
      <li className="clinics__list-item">
        <h3>Bebedouro</h3>
        <p>Praça da Matriz, 100 - Centro</p>
      </li>
      <li className="clinics__list-item">
        <h3>Franca</h3>
      ...
      <li className="clinics__list-item">
        <h3>Jaboticabal</h3>
        <p>Rui Barbosa, 619 - Centro</p>
      </li>
      <li className="clinics__list-item">
        <h3>Sertãozinho</h3>
        <p>Barão do Rio Branco, 1378 - Centro</p>
      </li>
      <li className="clinics__list-item">
        <h3>Araraquara</h3>
        <p>Rua 2, 602 - Centro</p>
      </li>
    </ul>
  );
};
