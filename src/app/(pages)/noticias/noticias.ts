...
export const exams: PageData[] = [
  {
    ...
    text: `
                ...
                <header>
                    <h1 class="text-3xl md:text-4xl font-bold text-gray-900 mb-6">Implante Dentário: O Guia Completo para Recuperar seu Sorriso com Confiança</h1>
                </header>
                ...
                <section id="agendamento-cta" class="mb-10 text-center bg-gray-50 p-6 rounded-lg">
                    ...
                    <a href="#agendamento" class="cta-button inline-block bg-blue-600 text-white font-bold py-3 px-6 rounded-lg text-lg shadow-md hover:bg-blue-700 transition-colors duration-200 no-underline">Agende sua Avaliação para Implante Dentário</a>
                </section>
  ...
  },
  {
    ...
    text: `
                <article class="max-w-4xl mx-auto px-4 py-8 sm:px-6 lg:px-8 font-sans">
                <header>
                    <h1 class="text-3xl md:text-4xl font-bold text-gray-900 mb-6">Pós-Operatório do Implante Dentário: Guia de Cuidados para uma Recuperação Tranquila</h1>
                </header>
